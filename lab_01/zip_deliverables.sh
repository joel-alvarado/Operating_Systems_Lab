...
zip -r deliverables/ex5.zip exercise_5/include exercise_5/src exercise_5/CMakeLists.txt
zip -r deliverables/ex6.zip exercise_6/include exercise_6/src exercise_6/CMakeLists.txt